...
export default function FAQ({
  ...
  return (
    <div className="">
      ...
      <div className="mt-0 rounded-xl bg-gradient-to-r from-gray-100 to-gray-300 p-4 dark:bg-gradient-to-r dark:from-gray-700 dark:to-gray-800 dark:text-gray-300 xs:px-1 md:px-4 lg:px-8">
