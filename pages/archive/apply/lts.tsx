      ...
      <ApplySection title="Lite.Space Long Term Support">
        <div className="my-8 mt-10 xs:my-4">
          ...
          <p>
            ...
            support to contributors to Litecoin and Free and Open Source
            Software (FOSS) tools. Our ambition is to ensure that innovative
            projects within the Litecoin community receive the necessary
            resources to flourish and contribute to the public's access to
            Litecoin infrastructure.
          </p>

          <h4>Application Criteria</h4>
          <p>
            If you are a developer or a project initiator keen on contributing
            to the Litecoin community or associated FOSS tools, we welcome you
            to apply for support through Lite.Space.
          </p>
          <ul>
            <li>
              Demonstrable contributions to Litecoin or associated FOSS
              projects.
            </li>
            <li>
            ...
            <li>
              Collaborative approach towards users and other contributors.
            </li>
          </ul>
          <p>
            If you believe in our vision and have a project in mind, apply
            below!
          </p>
          <LTSApplicationForm />
        </div>
