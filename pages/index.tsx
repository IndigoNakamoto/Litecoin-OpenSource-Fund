...
export default function Mission({
  ...
  return (
    <>
      ...
      <div className="z-9 absolute inset-x-0 bottom-0 top-[600px] flex items-center justify-center">
        <div className="container px-6">
          <h1 className="text-6xl font-extrabold leading-9 tracking-tight text-gray-100 sm:text-6xl sm:leading-10 md:text-6xl md:leading-14 lg:text-8xl xl:col-span-2">
            Mission
          </h1>
          <h2 className="mb-4 text-3xl font-bold leading-normal text-gray-100 md:text-4xl lg:text-5xl">
