  ...
  return (
    <>
      ...
      <div className="max-w-full">
        ...
        <div className="prose mt-0 max-w-none rounded-xl bg-gradient-to-b from-gray-50 to-gray-100 p-8 text-xl dark:prose-dark  dark:from-gray-700 dark:to-gray-800">
          {children}
        </div>
      </div>
    </>
