...
export default function PageHeading({ title, children }: Props) {
  return (
    <div className="">
      ...
      <div className="mt-0 rounded-xl bg-gradient-to-b from-gray-200 to-gray-100 dark:from-gray-800 dark:to-gray-700 dark:text-gray-300 xs:px-4 md:px-4 lg:px-8">
        {children}
      </div>
    </div>
  )
